...
<ins>Mapbase install instructions:</ins> Click code, Download .zip, extract, copy & overwrite `shared_misc` folder at:
`steamapps\sourcemods\mapbase_shared\shared_misc`
then add half-life2.fgd to Hammer config.

<ins>Entropy Zero 2 install instructions:</ins> Click code, Download .zip, extract, copy & overwrite `entropyzero2` folder at:
...
| TeamSpen210 | Some entity icons like point_entity_finder are by them (i asked nicely) and I based some like point_advanced_finder off of theirs as well. Inspiration & many fixes from their hammeraddons fgd. | https://github.com/TeamSpen210 |
...
| The Spud Lord | When Ficools tf2 FGD disappeared, he stepped up. Inspiration & many fixes from their fgd. | https://tf2maps.net/threads/an-fgd-fit-for-a-lord.41812/ |
| Brokkhouse | After spud lord left, Brokkhouse took the team fortress 2 .fgd throne. Another invaluable reference point for their inherited .FGD knowledge. | https://tf2maps.net/downloads/an-fgd-fit-for-a-lord-brokk-edition.15924/ |
